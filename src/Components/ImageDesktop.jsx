...
function CustomSVG(props) {
  ...
  return (
    <svg className="widgetMain_top_image_one" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 176 207.458">
      <g id="Groupe_195" data-name="Groupe 195" transform="translate(-655 -113.548)">
        <path id="Soustraction_2" data-name="Soustraction 2" d="M-1502.861,1721h-92.278a47.388,47.388,0,0,1-.861-9,46.708,46.708,0,0,1,3.693-18.294,46.843,46.843,0,0,1,10.072-14.939,46.843,46.843,0,0,1,14.939-10.073A46.707,46.707,0,0,1-1549,1665a46.7,46.7,0,0,1,18.294,3.693,46.845,46.845,0,0,1,14.94,10.073,46.847,46.847,0,0,1,10.073,14.939A46.706,46.706,0,0,1-1502,1712a47.388,47.388,0,0,1-.861,9Z" transform="translate(2251 -1401)" fill={colorDark}/>
        <path id="Soustraction_1" data-name="Soustraction 1" d="M-1467,1817h-118.109a73.684,73.684,0,0,1-5.89-29,73.686,73.686,0,0,1,5.972-29.194,74.716,74.716,0,0,1,7.007-12.74,75.766,75.766,0,0,1,9.28-11.1,76.347,76.347,0,0,1,11.248-9.158,76.34,76.34,0,0,1,12.91-6.915A76.394,76.394,0,0,1-1515,1713a76.682,76.682,0,0,1,25.919,4.474A75.976,75.976,0,0,1-1467,1729.849V1817Z" transform="translate(2298 -1497.001)" fill={color}/>
        <g id="undraw_happy_feeling_re_e76r" transform="translate(637.685 113.548)">
          ...
          <path id="Tracé_23" data-name="Tracé 23" d="M227.377,169.523l-12.228,1.248-7.736,44.421,23.458,3.743Z" transform="translate(-83.274 -93.654)" fill={color}/>
